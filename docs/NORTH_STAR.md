...
**Standing orientation.** Updated 2026-08-17 by Daniel + Grok Web; recorded by Grok Build.  
Lane-keep is the **evaluation harness**, not the product.
...
The frozen 128×128 lap (IN_LANE ON_LINE, max 15.7 cm, 81% @ 10 cm) is in the **travel** ballpark **in sim**. It is not docking-grade. A clean 10–16 cm band in ideal Webots will open up on real hardware (lighting, calibration, latency, play). Design corridors and safety margins with that gap.
...
| Drive policy (this phase) | `kahead=0.22`, release `4.0`, cruise 5.5, picture-wins, LINE_CAM 128×128. Metric path and SIDELOOK closed unless explicitly reopened. |
