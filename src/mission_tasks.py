...
TASK_PROFILES: dict[str, TaskProfile] = {
    "idle": TaskProfile(
        ...
        draw_targets={"Legs": 5.0, "Arms": 8.0, "Torso": 5.5, "Compute": 10.5, "Cooling": 2.0},
        budget_factor=0.70,
        throttle_order=["Arms", "Torso", "Legs", "Compute", "Cooling"],
        max_draw_delta=0.22,
        variation_band=0.05,
        smooth_factor=0.14,
    ),
    "moving": TaskProfile(
        ...
        description="Wheeled locomotion active — drive motors and torso load increase; arms tucked for transit.",
        draw_targets={"Legs": 26.0, "Arms": 11.0, "Torso": 13.5, "Compute": 12.0, "Cooling": 4.5},
        budget_factor=0.92,
        throttle_order=["Compute", "Arms", "Torso", "Legs", "Cooling"],
        max_draw_delta=0.40,
        variation_band=0.07,
        smooth_factor=0.18,
    ),
    "balanced": TaskProfile(
        ...
        draw_targets={"Legs": 16.0, "Arms": 12.0, "Torso": 10.0, "Compute": 11.5, "Cooling": 3.5},
        budget_factor=0.82,
        throttle_order=["Arms", "Compute", "Torso", "Legs", "Cooling"],
        max_draw_delta=0.30,
        variation_band=0.06,
        smooth_factor=0.16,
    ),
    "high_load": TaskProfile(
        ...
        draw_targets={"Legs": 31.0, "Arms": 22.0, "Torso": 17.0, "Compute": 13.5, "Cooling": 6.5},
        budget_factor=1.0,
        throttle_order=["Compute", "Torso", "Arms", "Legs", "Cooling"],
        max_draw_delta=0.50,
        variation_band=0.08,
        smooth_factor=0.20,
    ),
